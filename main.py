...
############
btn1 = Button(mainFrame,width=110,height=110,bg='white',fg='white',image=white,command=lambda : clicked(1,80,100))
btn1.place(x=80,y=100)

btn2 = Button(mainFrame,width=110,height=110,bg='white',fg='white',image=white,command=lambda :clicked(2,200,100))
btn2.place(x=200,y=100)

btn3 = Button(mainFrame,width=110,height=110,bg='white',fg='white', image=white,command=lambda :clicked(3,320,100))
btn3.place(x=320,y=100)

###########
btn4 = Button(mainFrame,width=110,height=110,bg='white',fg='white', image=white,command=lambda :clicked(4,80,220))
btn4.place(x=80,y=220)

btn5 = Button(mainFrame,width=110,height=110,bg='white',fg='white',image=white,command=lambda :clicked(5,200,220))
btn5.place(x=200,y=220)

btn6 = Button(mainFrame,width=110,height=110,bg='white',fg='white', image=white,command=lambda :clicked(6,320,220))
btn6.place(x=320,y=220)


############
btn7 = Button(mainFrame,width=110,height=110,bg='white',fg='white', image=white,command=lambda :clicked(7,80,340))
btn7.place(x=80,y=340)

btn8 = Button(mainFrame,width=110,height=110,bg='white',fg='white',image=white,command=lambda :clicked(8,200,340))
btn8.place(x=200,y=340)

btn9 = Button(mainFrame,width=110,height=110,bg='white',fg='white', image=white,command=lambda :clicked(9,320,340))
